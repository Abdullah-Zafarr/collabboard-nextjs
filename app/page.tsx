...
import { ArrowRight, CalendarDays, CheckCircle2, LayoutDashboard, MessageSquareText, Radio, ShieldCheck, Sparkles, Users } from "lucide-react";
    ...
    <main className="min-h-screen overflow-hidden bg-[#f8faf9] text-slate-950">
      ...
      <section className="relative mx-auto grid max-w-7xl gap-14 px-6 pb-24 pt-16 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:pt-24">
        <div className="relative z-10 flex flex-col justify-center">
          <div className="mb-6 flex w-fit items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.15em] text-emerald-700"><Sparkles className="size-3.5" /> Work in sync</div>
        ...
        <div className="relative min-h-[500px]">
          ...
          <div className="relative h-full rotate-1 rounded-[2rem] border border-white bg-white/85 p-5 shadow-[0_35px_80px_-30px_rgba(15,23,42,0.28)] backdrop-blur">
